...
| Name | Type |
|------|------|
| [davinci_connection.connector-telesign](https://registry.terraform.io/providers/samir-gandhi/davinci/latest/docs/resources/connection) | resource |
...
| <a name="input_connector_name"></a> [connector\_name](#input\_connector\_name) | Name of Connector | `string` | `"TeleSign"` | no |
...
| <a name="input_providerName"></a> [providerName](#input\_providerName) | Provider Name | `string` | n/a | yes |
